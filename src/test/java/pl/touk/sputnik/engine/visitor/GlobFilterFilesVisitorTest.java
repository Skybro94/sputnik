...
class GlobFilterFilesVisitorTest {
    ...
    void shouldFilterOutTestFiles() {
        ...
        new GlobFilterFilesVisitor("module1/*.xml").beforeReview(review);

        assertThat(review.getFiles()).hasSize(1);
        assertThat(review.getFiles()).extracting("reviewFilename").containsExactly("module1/pom.xml");
    }
